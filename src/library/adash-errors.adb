   ...
   begin
      case Code is
         ...
         when Error_Stream_Not_Redirected  =>
            return Adash.Messages.Msg_Stream_Not_Redirected;
         ...
         when Error_Package_Starts_A_Task  =>
            return Adash.Messages.Msg_Package_Starts_A_Task;
         ...
         when Error_Aggregate_Others_Covers_Nothing =>
            return Adash.Messages.Msg_Aggregate_Others_Covers_Nothing;
