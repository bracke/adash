...
package Adash.Messages is
   ...
   Msg_Output_Too_Large,
      ...
      Msg_No_Previous_Directory,
      Msg_No_Directory_Set_Aside,
      Msg_Unknown_Stream,
      Msg_Stream_Not_Redirected,
      Msg_Unknown_Signal,
   ...
   Msg_Source_Too_Large,
      ...
      Msg_Needs_Bounds,
      Msg_Open_By_Element,
      Msg_Too_Many_At_Once,
      Msg_Too_Many_Parameters,
      Msg_List_Alternatives,
      Msg_List_Parameters,
      Msg_List_Components,
      Msg_List_Values,
      Msg_List_Names,
   ...
   Msg_Predefined_All_Of_Pipe_Doc,
      ...
      Msg_Predefined_Read_File_Doc,
   Msg_Predefined_Current_Directory_Doc,
   Msg_Predefined_File_Count_Doc,
   ...
   Msg_Predefined_Stage_Count_Doc,
   ...
   Msg_Predefined_Error_Of_Hint,
   Msg_Predefined_All_Of_Hint,
   Msg_Predefined_Output_Of_Pipe_Hint,
   Msg_Predefined_Error_Of_Pipe_Hint,
   Msg_Predefined_All_Of_Pipe_Hint,
      ...
      Msg_Predefined_Read_File_Hint,
   Msg_Predefined_Current_Directory_Hint,
   Msg_Predefined_File_Count_Hint,
   ...
   Msg_Predefined_Stage_Count_Hint,
   Msg_Predefined_Stage_Status_Hint,
      ...
      Msg_Command_Push_Directory_Doc, Msg_Command_Pop_Directory_Doc,
      Msg_Command_Directories_Doc,
      Msg_Command_Run_Matching_Doc,
      Msg_Command_Run_Instead_Doc,
      Msg_Command_Redirect_Doc, Msg_Command_Redirect_Append_Doc,
   ...
   Msg_Command_Run_Errors_Into_Doc,
   ...
   Msg_Command_Pipe_All_New_Doc,
      ...
      Msg_Command_Stop_Process_Doc, Msg_Command_On_Interrupt_Doc,
   ...
   Msg_Command_Copy_File_Doc,
   Msg_Command_On_Exit_Doc, Msg_Command_Append_File_Doc,
      Msg_Command_Hint,
