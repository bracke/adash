...
package body Adash.Predefined is
   ...
   Registry : constant array (Positive range <>) of Metadata :=
     [
      ...
      (Id => Entity_Braces_Count, Name => Named ("Braces_Count"),
       Sort => Sort_Function,
       Of_Type => Types.Type_Integer, Parameter_Count => 1,
       Parameters => [1 => (Named ("Text"), Types.Type_String),
                      others => (Named (""), Types.Type_None)],
       Optional_Parameters => 0, Has_Side_Effects => False,
       Documentation => Adash.Messages.Msg_Predefined_Braces_Count_Doc,
       Description => Adash.Messages.Msg_Predefined_Braces_Count_Hint,
       Status => Available),

      (Id => Entity_Braces_At, Name => Named ("Braces_At"),
       Sort => Sort_Function,
       ...
       Parameters => [1 => (Named ("Text"), Types.Type_String),
                      ...
                      others => (Named (""), Types.Type_None)],
       Optional_Parameters => 0, Has_Side_Effects => False,
       Documentation => Adash.Messages.Msg_Predefined_Braces_At_Doc,
       Description => Adash.Messages.Msg_Predefined_Braces_At_Hint,
       Status => Available),

      (Id => Entity_Match_Count, Name => Named ("Match_Count"),
       Sort => Sort_Function,
       Of_Type => Types.Type_Integer, Parameter_Count => 1,
       Parameters => [1 => (Named ("Pattern"), Types.Type_String),
                      others => (Named (""), Types.Type_None)],
       Optional_Parameters => 0, Has_Side_Effects => False,
       Documentation => Adash.Messages.Msg_Predefined_Match_Count_Doc,
       Description => Adash.Messages.Msg_Predefined_Match_Count_Hint,
       Status => Available),

      (Id => Entity_Match_At, Name => Named ("Match_At"),
       Sort => Sort_Function,
       Of_Type => Types.Type_String, Parameter_Count => 2,
       Parameters => [1 => (Named ("Pattern"), Types.Type_String),
                      2 => (Named ("Position"), Types.Type_Integer),
                      others => (Named (""), Types.Type_None)],
       Optional_Parameters => 0, Has_Side_Effects => False,
       Documentation => Adash.Messages.Msg_Predefined_Match_At_Doc,
       Description => Adash.Messages.Msg_Predefined_Match_At_Hint,
       Status => Available),
      ...
      (Id => Entity_Left_Aligned, Name => Named ("Left_Aligned"),
       Sort => Sort_Function,
       Of_Type => Types.Type_String, Parameter_Count => 2,
       Parameters => [1 => (Named ("Text"), Types.Type_String),
                      2 => (Named ("Width"), Types.Type_Integer),
                      others => (Named (""), Types.Type_None)],
       Optional_Parameters => 0, Has_Side_Effects => False,
       Documentation => Adash.Messages.Msg_Predefined_Left_Aligned_Doc,
       Description => Adash.Messages.Msg_Predefined_Left_Aligned_Hint,
       Status => Available),

      (Id => Entity_Right_Aligned, Name => Named ("Right_Aligned"),
       Sort => Sort_Function,
       Of_Type => Types.Type_String, Parameter_Count => 2,
       Parameters => [1 => (Named ("Text"), Types.Type_String),
                      2 => (Named ("Width"), Types.Type_Integer),
                      others => (Named (""), Types.Type_None)],
       Optional_Parameters => 0, Has_Side_Effects => False,
       Documentation => Adash.Messages.Msg_Predefined_Right_Aligned_Doc,
       Description => Adash.Messages.Msg_Predefined_Right_Aligned_Hint,
       Status => Available),

      (Id => Entity_Zero_Padded, Name => Named ("Zero_Padded"),
       Sort => Sort_Function,
       Of_Type => Types.Type_String, Parameter_Count => 2,
       Parameters => [1 => (Named ("Text"), Types.Type_String),
                      2 => (Named ("Width"), Types.Type_Integer),
                      others => (Named (""), Types.Type_None)],
       Optional_Parameters => 0, Has_Side_Effects => False,
       Documentation => Adash.Messages.Msg_Predefined_Zero_Padded_Doc,
       Description => Adash.Messages.Msg_Predefined_Zero_Padded_Hint,
       Status => Available),

      (Id => Entity_Decimals, Name => Named ("Decimals"),
       Sort => Sort_Function,
       Of_Type => Types.Type_String, Parameter_Count => 2,
       Parameters => [1 => (Named ("Value"), Types.Type_Float),
                      2 => (Named ("Places"), Types.Type_Integer),
                      others => (Named (""), Types.Type_None)],
       Optional_Parameters => 0, Has_Side_Effects => False,
       Documentation => Adash.Messages.Msg_Predefined_Decimals_Doc,
       Description => Adash.Messages.Msg_Predefined_Decimals_Hint,
       Status => Available),
